...
import type { ModuleJsonFile } from './file/module-json'
 ...
 */
export interface Product extends Directory {
  /**
   * Get the current module of the product.
   *
   * @returns The current module of the product.
   */
  getModule(): Module
  /**
   * Get the module json of the product.
   *
   * @returns The module json of the product.
   */
  getModuleJson(): Promise<ModuleJsonFile>
  /**
   * Get the resources of the product.
   *
   * @returns The resources of the product.
   */
