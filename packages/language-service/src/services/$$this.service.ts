...
export function createETS$$ThisService(arktsExtraLanguageService: ArkTSExtraLanguageService): LanguageServicePlugin {
  const locale = arktsExtraLanguageService.getLocale()
    ...
    create(context) {
      ...
      return {
        provideHover(document, position) {
          ...
          const positions = arktsExtraLanguageService.get$$ThisPositions(sourceFile, document)
