 ...
 */
export interface WorkspaceLevelBuildProfile {
  ...
  app: WorkspaceLevelBuildProfile.App
  ...
  modules: WorkspaceLevelBuildProfile.Module[]
}

export namespace WorkspaceLevelBuildProfile {
  export function is(value: unknown): value is WorkspaceLevelBuildProfile {
    return typeof value === 'object'
      ...
      && value.modules.every(mod => WorkspaceLevelBuildProfile.isModule(mod))
  }
}
